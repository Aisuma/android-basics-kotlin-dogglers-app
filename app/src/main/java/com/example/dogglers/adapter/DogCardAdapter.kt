...
//        val toInflate = layout
//        fun inflateFromLayout(LayoutType: Int) {
//            LayoutInflater.from(parent.context).inflate(LayoutType)
//        }

        val dogViewHolder: View? = if (layout == Layout.GRID) {
    ...
    override fun getItemCount(): Int = dogData.size // DONE: return the size of the data set instead of 0
